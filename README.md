...
แอปนี้ไม่มีระบบ login — **อย่าเปิดพอร์ตให้เข้าถึงจากอินเทอร์เน็ตตรง ๆ โดยไม่มีการป้องกัน**
เพราะใครก็ตามที่รู้ IP/URL จะเพิ่ม-ลบรายการหรือดูรายการอ่านของเราได้ แนะนำอย่างใดอย่างหนึ่ง:

- วางหลัง nginx + Basic Auth (`htpasswd`), หรือ
